...
export default function Home() {
  ...
  return (
    <main className="w-full h-full px-2">
      <picture className={`gap-5 p-3 rounded-3xl ${theme === 'ligth' ? 'border-black' : 'border-white' }  border-2 w-full h-3/4 flex items-center justify-center`}>
        <img src={ MyPhoto } alt="Hector Souza" className='w-2/6 h-full rounded-3xl'/>
        <div>
