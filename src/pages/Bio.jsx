      ...
      <div className="w-full items-center justify-center flex gap-10">
        <div className="w-1/3 text-justify">
          ...
          <div className="w-full text-right">
            <a href="https://www.linkedin.com/in/hectorsouza/" target="_blank" rel="noreferrer" className="text-xs text-end hover:text-slate-500">clique para saber mais sobre carreira...</a>
          </div>
        </div>
        <img src={ eu } alt="formação" className="w-2/6 rounded-full"/>
      </div>
      <div className="w-full items-center justify-center flex">
        <img src={ study } alt="formação" className="w-2/6"/>
        <div className="w-2/6">

          <h1 className="text-2xl text-center py-3">Formação</h1>
          <div className="py-3">
            <h2 className={`p-1 ${theme === 'ligth' ? 'bg-black text-white' : 'bg-white text-black' } text-center rounded-xl w-44`}>Nov/2022 - Nov/2023</h2>
            <h3 className="pl-5">Desenvolvimento Web Full Stack - <strong><a href="betrybe.com" target="_blank">Trybe</a></strong></h3>
          </div>

          <div className="py-3">
            <h2 className={`p-1 ${theme === 'ligth' ? 'bg-black text-white' : 'bg-white text-black' } text-center rounded-xl w-44`}>Jun/2019 - Em pausa</h2>
            <h3 className="pl-5">Sistemas de informação - UNIFTC</h3>
          </div>

          <div className="py-3">
            <h2 className={`p-1 ${theme === 'ligth' ? 'bg-black text-white' : 'bg-white text-black' } text-center rounded-xl w-44`}>Jun/2016 - Jun/2018</h2>
            <h3 className="pl-5">Técnico em Mecânica, SENAI</h3>
          </div>
        </div>
      </div>
    </section>
